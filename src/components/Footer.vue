  ...
  <div className="bg-white w-full p-8">
    <div className="grid grid-rows-1 gap-8 md:grid-cols-12 xl:gap-8">
      ...
      <div className="md:col-span-4 xl:col-span-3">
        ...
        <nav>
          <a href="https://www.facebook.com/jtdevsmx"
            className="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-lg transition-colors" target="_blank">
            <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" className="w-[20px] h-[20px]"
              alt="JT Devs" />
            JT Devs
          </a>
          <a href="https://www.instagram.com/jtdevsmx/"
            className="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-lg transition-colors" target="_blank">
            <Image src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" className="w-[20px] h-[20px]"
              alt="JT Devs" />
            jtdevsmx
          </a>
          <a href="https://twitter.com/jtdevsmx"
            className="flex items-center gap-2 hover:bg-gray-100 p-2 rounded-lg transition-colors" target="_blank">
            <Image src="https://cdn-icons-png.flaticon.com/512/1384/1384065.png" className="w-[20px] h-[20px]"
              alt="JT Devs" />
            JT Devs
          </a>
        </nav>
